                    ...
                    children: [
                      {
                        ...
                        meta: {
                          title: 'ES6知识',
                          group: { title: '教程', path: '/course', order: 20 },
                          slugs: [
                            {
                              depth: 1,
                              value: 'let、cosnt、var',
                      ...
                      {
                        path: '/course/001react',
                        title: 'react基础知识',
                        meta: {
                          title: 'react基础知识',
                          group: { title: '教程', path: '/course', order: 1 },
                          slugs: [
                            {
                              depth: 1,
                              value: 'tsx 语法',
                      ...
                      {
                        path: '/course/040umi_dva',
                        title: 'umi&dva知识篇',
                        meta: {
                          title: 'umi&dva知识篇',
                          group: { title: '教程', path: '/course', order: 40 },
                          slugs: [
                      ...
                      {
                        path: '/course/050wetrial',
                        title: 'wetrial相关库',
                        meta: {
                          title: 'wetrial相关库',
                          group: { title: '教程', path: '/course', order: 50 },
                          slugs: [
                            {
                              depth: 1,
                              value: '@wetrial/core',
                      ...
                      {
                        path: '/course/002library',
                        title: '常用组件篇',
                        meta: {
                          title: '常用组件篇',
                          group: { title: '教程', path: '/course', order: 2 },
                          slugs: [
                            {
                              depth: 1,
                              value: 'react-router',
                      ...
                      {
                        path: '/course/030codestyle',
                        title: '代码规范lint',
                        meta: {
                          title: '代码规范lint',
                          group: { title: '教程', path: '/course', order: 30 },
                          slugs: [
                            {
                              depth: 1,
                              value: '样式 代码规范',
                      ...
                      {
                        path: '/course/010typescript',
                        title: 'typescript知识',
                        meta: {
                          title: 'typescript知识',
                          group: { title: '教程', path: '/course', order: 10 },
                          slugs: [
                            {
                              depth: 1,
                              value: '类型约束',
                    ...
                    children: [
                      {
                        ...
                        meta: {
                          title: '区块',
                          group: { title: '其他', path: '/other', order: 1 },
                          slugs: [
                            {
                              depth: 1,
                              value: '使用区块',
                      ...
                      },
                      {
                        ...
                        meta: {
                          title: '部署',
                          group: { title: '其他', path: '/other', order: 2 },
                          slugs: [
                            {
                              depth: 1,
                              value: '前端路由与服务端的结合',
                    ...
                    children: [
                      {
                        ...
                        meta: {
                          title: '样式使用',
                          group: { title: '样式', path: '/style', order: 5000 },
                          slugs: [
                    ...
                    children: [
                      {
                        ...
                        meta: {
                          title: '页面规范',
                          group: { title: '设计', path: '/design', order: 1 },
                          slugs: [
                            {
                              depth: 1,
                              value: '列表页面',
