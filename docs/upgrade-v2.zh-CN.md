...
注：该迁移指南是基于当前最新的 v1 版本编写的，迁移指南对应的修改你可以在升级示例的 [commit](https://github.com/wetrial/wetrial-site/commit/dc2118db78f9b2b7072051fea558e8d1386ce34c) 中查看。该 commit 只作为参考，不能直接应用在你的项目中，如果你的版本过老可能会有一些细节不一样，请结合具体情况迁移
...
- 修改 `BasicLayout` 中的 `getPageTitle` 和 `getBreadcrumbNameMap` 的相关逻辑，参考下面的代码实现。完整代码参考 v1 升级 [commit](https://github.com/wetrial/wetrial-site/commit/dc2118db78f9b2b7072051fea558e8d1386ce34c)。
